...
<head>
<meta charset="UTF-8">
<title>Commercial Draft - <?php echo e($invoice->seller_business_name ?? ''); ?></title>
<style>
...
<body>
  ...
  <div class="page">
    ...
    <table class="items">
      ...
      <tbody>
        <?php $__currentLoopData = $itemsCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          ?>
          <tr>
            <td class="left"><?php echo e($itemArray['productDescription'] ?? '-'); ?></td>
    ...
    <?php $grandTotal += floatval($invoice->expense_col ?? 0); ?>
    <div class="total-row">
...
</html><?php /**PATH C:\Users\Shahan Developer\FBR\resources\views/SaleInvoice/draft_commercial.blade.php ENDPATH**/ ?>