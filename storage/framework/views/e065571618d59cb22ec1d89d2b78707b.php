...
<head>
<meta charset="UTF-8">
<title>Commercial Invoice - <?php echo e($invoice->seller_business_name ?? ''); ?></title>
<style>
...
<body>
  ...
  <div class="page">
    ...
    <div class="stn-ntn-row">
      <div><b>STN :</b> <?php echo e($invoice->seller_ntn_cnic ?? ''); ?></div>
    ...
    <div class="buyer-meta-row">
      <div class="buyer-info">
        ...
        <div><b>CNIC</b> <?php echo e($invoice->buyer_ntn_cnic ?? ''); ?></div>
      </div>
      <div class="invoice-meta">
        <div><b>Invoice No.</b> <?php echo e($invoice->fbr_invoice_no ?? 'N/A'); ?></div>
    ...
    <table class="items">
      <thead>
        <tr>
          ...
          <th>Quantity<br><?php echo e($itemsCollection->first()['uoM'] ?? 'Kgs'); ?></th>
          <th>Unit Price<br><?php echo e($itemsCollection->first()['uoM'] ?? 'Kgs'); ?></th>
      ...
      <tbody>
        <?php $__currentLoopData = $itemsCollection; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <tr>
            ...
            <td><?php echo e(number_format($valueIncl, 2)); ?></td>
          </tr>
    ...
    <div class="total-row">
      ...
      <span class="amount">Rs. <?php echo e(number_format($grandTotal, 2)); ?></span>
    </div>
...
</html><?php /**PATH C:\Users\Shahan Developer\FBR\resources\views/SaleInvoice/commercial_print.blade.php ENDPATH**/ ?>