    ...
    <div class="card shadow-lg">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('users.store')); ?>" method="POST">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="company_id" id="" class="form-select select2">
                            ...
                            <?php $__currentLoopData = $company; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($comp->cid); ?>"><?php echo e($comp->cname); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
                ...
                <a href="<?php echo e(route('users.index')); ?>" class="btn btn-secondary w-100 mt-2">
                    Cancel
                </a>
...
</html><?php /**PATH /home/erplive/public_html/premiertax/resources/views/User/create.blade.php ENDPATH**/ ?>