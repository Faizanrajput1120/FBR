...
<head>
    <meta charset="utf-8" />
    <title>Premier Law Dashboard | Softix Technology - User Dashboard</title>
...
<body>
    ...
    <div class="wrapper">
        ...
        <!-- ========== Topbar Start ========== -->
       <?php echo $__env->make('components.user_topbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- ========== Topbar End ========== -->

        <!-- ========== Left Sidebar Start ========== -->
       <?php echo $__env->make('components.user_sidebar2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- ========== Left Sidebar End ========== -->
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="theme-settings-offcanvas">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="https://softix.com.pk/" target="_blank" role="button" class="btn btn-primary w-100">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
...
<script src="<?php echo e(asset('printingcell/public/assets/js/jquery-item.min.js')); ?>"></script>
...
<?php /**PATH /home/erplive/public_html/premiertax/resources/views/layouts/user_layout.blade.php ENDPATH**/ ?>