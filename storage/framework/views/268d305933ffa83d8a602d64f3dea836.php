            ...
            <?php if($user?->is_admin == 1): ?>
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="inventoryMenu">
                        <ul class="side-nav-second-level">
                            <li>
                                <a href="<?php echo e(route('inventory.itemmaster.list')); ?>">Item List</a>
                            </li>
                            <li>
                                <a href="<?php echo e(route('inventory.create.itemmaster')); ?>">Register Item</a>
                            </li>
                        </ul>
                    </div>
                </li>
...
<?php /**PATH C:\Users\Shahan Developer\FBR\FBR\resources\views/components/sidebar.blade.php ENDPATH**/ ?>