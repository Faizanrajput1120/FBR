...
<head>
    ...
    <title>Sales Tax Invoice - <?php echo e($invoice->seller_business_name ?? 'N/A'); ?></title>
    <style>
...
<body>
    ...
    <div class="invoice-box">
        ...
        <div class="header-top">
            <h1>M/S <?php echo e($invoice->seller_business_name ?? 'N/A'); ?></h1>
        ...
        <div class="details-section">
            <div class="details-left">
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($invoice->buyer_business_name ?? ''); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Address:</span>
                    <span class="detail-value"><?php echo e($invoice->buyer_address ?? 'LAHORE-PAKISTAN'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Sales Tax Reg No:</span>
                    <span class="detail-value"><?php echo e($invoice->buyer_ntn_cnic ?? ''); ?></span>
                </div>
                <div class="detail-row">
            ...
            <div class="details-right">
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($invoice->fbr_invoice_no ?? '0001'); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Invoice Date:</span>
                    <span class="detail-value"><?php echo e(\Carbon\Carbon::parse($invoice->invoice_date ?? now())->format('d-M-y')); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Sales Tax Reg No:</span>
                    <span class="detail-value"><?php echo e($invoice->seller_ntn_cnic ?? ''); ?></span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">NTN No:</span>
                    <span class="detail-value"><?php echo e($invoice->seller_ntn_cnic ?? ''); ?></span>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value"><?php echo e($invoice->invoice_ref_no ?? '-'); ?></span>
                </div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-left"><?php echo e($itemArray['product_description'] ?? $itemArray['productDescription'] ?? '-'); ?></td>
                    <td><?php echo e(number_format($qty, 3)); ?></td>
                    <td><?php echo e(number_format($retailExcl)); ?></td>
                    <td><?php echo e(number_format($salesTax)); ?></td>
                    <td><?php echo e(number_format($retailIncl)); ?></td>
                    <td><?php echo e($discount > 0 ? number_format($discount) : '-'); ?></td>
                    <td><?php echo e(number_format($tradeExcl)); ?></td>
                    <td><?php echo e(number_format($salesTax)); ?></td>
                    <td><?php echo e(number_format($tradeWithTax)); ?></td>
                    <td><?php echo e($furtherTax > 0 ? number_format($furtherTax, 2) : '-'); ?></td>
                    <td class="amount-col"><?php echo e(number_format($amount)); ?></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>-</td>
                    <td>-</td>
                    <td class="amount-col"><?php echo e(number_format($extraAmount)); ?></td>
                </tr>
                <?php
                    $grandQty += 0;
                ...
                <tr class="total-row">
                    ...
                    <td><?php echo e(number_format($grandQty)); ?></td>
                    <td><?php echo e(number_format($grandRetailExcl)); ?></td>
                    <td><?php echo e(number_format($grandRetailTax)); ?></td>
                    <td><?php echo e(number_format($grandRetailIncl)); ?></td>
                    <td><?php echo e(number_format($grandDiscount)); ?></td>
                    <td><?php echo e(number_format($grandTradeExcl)); ?></td>
                    <td><?php echo e(number_format($grandTradeTax)); ?></td>
                    <td><?php echo e(number_format($grandTradeWithTax)); ?></td>
                    <td><?php echo e(number_format($grandFurtherTax, 2)); ?></td>
                    <td><?php echo e(number_format($grandAmount)); ?></td>
                </tr>
            </tbody>
        </table>
