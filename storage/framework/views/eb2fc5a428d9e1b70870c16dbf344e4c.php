...
<head>
<meta charset="UTF-8">
<title>3rd Schedule Draft - <?php echo e($invoice->seller_business_name ?? ''); ?></title>
<style>
...
<body>
  ...
  <div class="page">
    ...
    <p class="company-address"><?php echo e($invoice->seller_address ?? ''); ?><br><?php echo e($invoice->seller_province ?? ''); ?></p>
    ...
    <div class="title-bar">3rd Schedule Draft — <?php echo e($invoice->buyer_business_name ?? ''); ?></div>
    <div class="buyer-meta-row">
      ...
      <div class="invoice-meta">
        <div><b>Draft No.</b> #<?php echo e($invoice->id); ?></div>
    ...
    <table class="items" id="itemsTable">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="desc"><?php echo e($itemArray['productDescription'] ?? '-'); ?></td>
        ...
        <?php $extraAmount = floatval($invoice->expense_col ?? 0); ?>
        ...
        <?php $grandAmount += $extraAmount; ?>
        <?php endif; ?>
      </tbody>
      <tfoot>
        <tr>
          <td colspan="2">Total Value Exclusive of Sales Tax</td>
          <td class="num"><?php echo e(number_format($grandQty, 3)); ?></td>
          <td class="num"><?php echo e(number_format($grandRetailExcl, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandRetailTax, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandRetailIncl, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandDiscount, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandTradeExcl, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandTradeTax, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandTradeWithTax, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandUS236, 0)); ?></td>
          <td class="num"><?php echo e(number_format($grandAmount, 0)); ?></td>
        </tr>
      </tfoot>
    </table>
    <table class="totals-block">
      ...
      <tr>
        ...
        <td class="t-val grand"><?php echo e(number_format($grandAmount + $grandFurtherTax, 0)); ?></td>
      </tr>
    </table>
...
</html><?php /**PATH C:\Users\Shahan Developer\FBR\resources\views/SaleInvoice/draft_third_schedule.blade.php ENDPATH**/ ?>