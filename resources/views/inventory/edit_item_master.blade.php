                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h4 class="header-title">Edit Item: {{ $itemMasters->item_code }}</h4>
                                        ...
                                        <form action="{{ route('inventory.itemmaster.update', $itemMasters->id) }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="item_code" class="form-control" name="item_code"
                                                            value="{{ old('item_code', $itemMasters->item_code) }}" placeholder="Enter Item Title" required>
                                                                    ...
                                                                    <optgroup label="{{ $heading->code }} - {{ $heading->description }}">
                                                                        @foreach($heading->subcategories as $sub)
                                                                            <option value="{{ $sub->code }}"
                                                                                {{ old('hs_code', $itemMasters->hscode) == $sub->code ? 'selected' : '' }}>
                                                        ...
                                                        <select name="unit" id="unit" class="form-control select2" required>
                                                            ...
                                                            @foreach ($units as $unitItem)
                                                                <option value="{{ $unitItem->unit_value }}"
                                                                    {{ old('unit', $itemMasters->unit) == $unitItem->unit_value ? 'selected' : '' }}>
                                                                    {{ $unitItem->unit_value }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="unit_value" class="form-control" name="unit_value"
                                                            value="{{ old('unit_value', $itemMasters->unit_value) }}" placeholder="Enter Unit Value" required step="any">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="gramage" class="form-control" name="gramage"
                                                            value="{{ old('gramage', $itemMasters->gramage) }}" placeholder="Enter Gramage" required step="any">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="sale" class="form-control" name="sale"
                                                            value="{{ old('sale', $itemMasters->sale) }}" placeholder="Enter Sale Tax %" required step="any">
                                                        @if ($errors->has('sale'))
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="purchase" class="form-control" name="purchase"
                                                            value="{{ old('purchase', $itemMasters->purchase) }}" placeholder="Enter Purchase Rate" required step="any">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="sale_rate" class="form-control" name="sale_rate"
                                                            value="{{ old('sale_rate', $itemMasters->sale_rate) }}" placeholder="Enter Sale Rate" required step="any">
                                            ...
                                            <div class="mb-3">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="mdi mdi-content-save"></i> Update Item
                                                </button>
