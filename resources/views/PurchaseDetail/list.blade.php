...
@section('content')
<div class="container">
    <h4 class="mt-3 mb-4">Purchase </h4>
    ...
    <form method="POST" action="{{ route('premiertax.purchase.store') }}">
        @csrf
        <div class="row mb-3">
            <div class="col-md-4">
                <label>Party</label>
                ...
                @if($saleAc && $saleAc->saleAcc)
                    <input type="hidden" name="p_account" value="{{ $saleAc->saleAcc->id }}">
                @endif
            </div>
        </div>
