...
@section('content')
    ...
    @endif
        ...
        <div class="row">
            ...
            <div class="col-6">
                <form action="{{ route('journal_voucher.reports') }}" method="GET" class="form-inline" id="search-form">
                    <div class="row">
    ...
    <select name="description" class="form-control select2" data-toggle="select2">
        ...
        @endforeach
                         ...
                         <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="{{ route('journal_voucher.list') }}" role="button" onclick="return checkPermission()" >Add New</a>
                                </div>
                ...
                <tbody>
                    ...
                    @foreach ($trndtls as $trndtl)
                        <tr>
                            ...
                            <td class="no-print">
                                <!-- Edit button -->
                                <a href="{{ route('journal_voucher.edit', $trndtl->v_no) }}" class="btn btn-warning btn-sm" onclick="return checkPermissionEdit()">Edit</a>
                               
                                <!-- Delete button (use form for method spoofing) -->
                                <form action="{{ route('journal_voucher.destroy', $trndtl->id) }}" method="POST" style="display:inline-block;" onclick="return checkPermissionDel()">
                                    @csrf
                                    @method('DELETE')
