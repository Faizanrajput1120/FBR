        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('journal_voucher.update', $voucher->first()->v_no) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <input type="hidden" id="invoice_type" class="form-control" name="v_type" value="JV" required readonly>
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody id="entryTableBody">
                                ...
                                <tr id="entryRow{{ $entry->id }}">
                                    ...
                                    <td>
                                        <!-- Delete Entry Button -->
                                        <a href="{{ route('journal_voucher.delete', $entry->id) }}"
