            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="col-12">
                            <form action="{{ route('cash.reports') }}" method="GET" class="form-inline col-xl-6"
                                id="search-form">
                                <div class="row">
...
<div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="{{ route('cash.list') }}" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
                                </div>
                            </form>
                                    ...
                                    @foreach ($trndtls as $trndtl)
                                        <tr>
                                            ...
                                            <td class="no-print">
                                                ...
                                                <form action="{{ route('cash.delete', $trndtl->id) }}" method="POST"
