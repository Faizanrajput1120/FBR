                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <!--<h1>{{$voucher->first()}}</h1>-->
                                    <form id="voucherForm" action="{{ route('cash.update', $voucher->first()->v_no) }}"
                                                    ...
                                                    @foreach ($voucher as $entry)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="cash[]" value="{{ $entry->cashes->id }}">
                                                            </td> <!-- Adjust based on your relationships -->
                                                            <td>{{ $entry->accounts->title ?? 'N/A' }}
                                                                <input type="hidden" name="account[]" value="{{ $entry->accounts->id }}">
                                                            </td> <!-- Adjust based on your relationships -->
                                                            ...
                                                            </td> <!-- Change this to the correct amount field, e.g. debit or credit -->
                                                            <td>
                                                                <!-- Delete Entry Button -->
