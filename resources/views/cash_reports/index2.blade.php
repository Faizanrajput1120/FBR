            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="col-12">
                            <form action="{{ route('payment.reports') }}" method="GET" class="form-inline col-xl-6"
                                id="search-form">
                                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        @endforeach
                                   ...
                                   <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="{{ route('payment.list') }}" role="button"  onclick="return checkPermission()">Add New</a>
                                </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="tab-content">
                        <div class="col-12">
                            ...
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                 <h4 class="page-title">Cash Payment Details</h4>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($trndtls as $trndtl)
                                        <tr>
                                            ...
                                            <td class="no-print">
                                                <!-- Edit button -->
                                                <a href="{{ route('payment.edit', $trndtl->v_no) }}"
                                                ...
                                                <form action="{{ route('payment.delete', $trndtl->id) }}" method="POST"
