    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Enter Freight Pharmaceutical</h4>
            </div>
        </div>
    </div>
    <!-- End page title -->
...
@endif
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                        <form id="voucherForm" action="{{ route('delivery_challan.updateDel', $v_no) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="col-6">
    ...
    <select name="freight_type" class="form-control select2" id="freight_type">
        ...
        <div class="mb-3" id="boxField" style="display: none;">
            <label for="box" class="form-label">Box</label>
            <input type="number" id="box" class="form-control" name="box" value="{{ $totalbox }}" readonly>
        </div>
