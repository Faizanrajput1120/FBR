                    ...
                    <div class="mb-6">
                        <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
                            <div class="flex-1 max-w-lg">
                                <form method="GET" action="{{ route('third.schedule.drafts.index') }}" class="flex">
                            ...
                            @if($search)
                                <div class="text-sm text-gray-600">
                                    ...
                                    <a href="{{ route('third.schedule.drafts.index') }}" class="ml-2 text-blue-600 hover:text-blue-800">Clear</a>
                                </div>
                            @endif
                        </div>
                    </div>
