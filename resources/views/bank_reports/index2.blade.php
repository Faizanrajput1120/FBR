...
@section('content')
    ...
    @endif
        ...
        <div class="row">
            ...
            <div class="col-12">
                <form action="{{ route('bank_recipt.reports') }}" method="GET" class="form-inline col-xl-6" id="search-form">
                    <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        @endforeach
                        ...
                        <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="{{ route('bank_recipt.list') }}" onclick="return checkPermission()" role="button">Add New</a>
                                </div>
                </form>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($trndtls as $trndtl)
                        <tr>
                            ...
                            <td class="no-print">
                                <!-- Edit button -->
                                <a href="{{ route('bank_recipt.edit', $trndtl->v_no) }}" class="btn btn-warning btn-sm" onclick="return checkPermissionEdit()">Edit</a>
                                ...
                                <form action="{{ route('bank_recipt.delete', $trndtl->id) }}" method="POST" style="display:inline-block;" onclick="return checkPermissionDel()">
                                    @csrf
                                    @method('DELETE')
