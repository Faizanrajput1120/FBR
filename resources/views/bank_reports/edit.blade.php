                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <form id="voucherForm" action="{{ route('bank_payment.update', $voucher->first()->v_no) }}"
                                        method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')

                                        <div class="col-xl-6">
                                            <input type="hidden" id="invoice_type" class="form-control" name="v_type" value="BPV" required readonly>
                                                ...
                                                <tbody id="entriesBody">
                                                    ...
                                                    @foreach ($voucher as $entry)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <!-- Delete Entry Button -->
                                                                <a href="{{ route('bank_payment.destroy', $entry->id) }}"
                                                                    class="btn btn-danger btn-sm"
                                                                    onclick="event.preventDefault();
                                                                    if(confirm('Are you sure you want to delete this transaction?')) {
                                                                        window.location.href='{{ route('bank_payment.destroy', $entry->id) }}';
                                                                    }">Delete</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
