...
@section('content')
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 items-center justify-between">
                            ...
                            @if($search)
                                <div class="text-sm text-gray-600">
                                    ...
                                    <a href="{{ route('draft-invoices.index') }}"
                                        class="ml-2 text-blue-600 hover:text-blue-800">Clear</a>
                                </div>
                            @endif
                        </div>
                    </div>
    ...
    <script>
        ...
        document.getElementById('confirmDelete').addEventListener('click', function () {
            if (draftToDelete) {
                fetch(`${API_BASE}/draftinvoices/${draftToDelete}`, {
                    method: 'DELETE',
                    headers: {
