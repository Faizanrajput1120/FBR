                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Edit General Job Sheet</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Edit General Job Sheet</h4>
                </div>
            </div>
        </div>
        <!-- End page title -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <form id="voucherForm" action="{{ route('general_job_sheet.update', $jobSheet->id) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="number" id="total_qty" class="form-control" name="total_qty" step="any" value="{{ $jobSheet->qty }}" readonly>
                                                </div>
                                                <div class="col-md-6 mb-3">
