...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Supplier Management</h6>
            <div>
...
@endif
        <div class="card-body">
            ...
            <!-- Search Form -->
            <div class="mb-4">
                <form action="{{ route('parties.index') }}" method="GET" class="form-inline">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="{{ route('parties.show', $party->id) }}" class="btn btn-info" title="View">
                                        <i class="fas fa-eye">View</i>
                                    </a>
                                    <a href="{{ route('parties.edit', $party->id) }}" class="btn btn-warning" title="Edit">
                                        <i class="fas fa-edit">EDIT</i>
                                    </a>
                                    <form action="{{ route('parties.destroy', $party->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
